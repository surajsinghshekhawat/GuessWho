    ...
    <div className="min-h-screen bg-red-500 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-2 sm:p-4">
        ...
        <div className="text-center mb-8 sm:mb-12">
          <h1 className="text-4xl sm:text-6xl lg:text-8xl font-bold text-white mb-2 sm:mb-4 drop-shadow-2xl tracking-wider">
            GUESS WHO
          </h1>
        ...
        <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-8 sm:mb-12">
          {/* How to Play Card - Takes 2 columns on desktop, full width on mobile */}
          <div className="lg:col-span-2 bg-white rounded-2xl shadow-2xl p-4 sm:p-6 lg:p-8">
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="flex gap-3 sm:gap-4 justify-center">
                    {/* Red Board Preview */}
                    <div className="bg-red-500 rounded-lg p-3 sm:p-4 shadow-lg">
                      <div className="text-white text-xs sm:text-sm font-bold mb-2">
                        Player 1
                      </div>
                      <div className="grid grid-cols-3 gap-1">
                        {[...Array(6)].map((_, i) => (
                          <div
                            key={i}
                            className="w-6 h-6 sm:w-8 sm:h-8 bg-yellow-300 rounded border border-gray-300"
                          ></div>
                        ))}
                      </div>
                    </div>
                    ...
                    {/* Blue Board Preview */}
                    <div className="bg-blue-500 rounded-lg p-3 sm:p-4 shadow-lg">
                      <div className="text-white text-xs sm:text-sm font-bold mb-2">
                        Player 2
                      </div>
                      <div className="grid grid-cols-3 gap-1">
          ...
          {/* Start Playing Card - Takes 1 column on desktop, full width on mobile */}
          <div className="lg:col-span-1 bg-white rounded-2xl shadow-2xl p-4 sm:p-6 lg:p-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-4 sm:mb-6 text-center">
              Start Playing
            </h2>
            ...
            <div className="mb-4 sm:mb-6">
              <button
                ...
                className="w-full bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 disabled:from-gray-400 disabled:to-gray-500 text-white font-bold py-2 sm:py-3 px-4 sm:px-6 rounded-lg transition-all duration-200 transform hover:scale-105 disabled:transform-none disabled:cursor-not-allowed shadow-lg text-sm sm:text-base"
              >
            ...
            <div className="space-y-3 sm:space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-center font-mono text-sm sm:text-base lg:text-lg tracking-wider"
                  maxLength={5}
                />
              </div>
              <button
